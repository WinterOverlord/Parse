...
import net.mcreator.parse.item.PurpleWorldItem;
import net.mcreator.parse.item.PurpleSwordItem;
import net.mcreator.parse.item.PurpleShovelItem;
import net.mcreator.parse.item.PurplePickaxeItem;
import net.mcreator.parse.item.PurpleItem;
import net.mcreator.parse.item.PurpleHoeItem;
import net.mcreator.parse.item.PurpleAxeItem;
import net.mcreator.parse.item.PurpleArmorItem;
...
public class ParseModItems {
	...
	public static final DeferredItem<Item> PURPLE = REGISTRY.register("purple", PurpleItem::new);
	public static final DeferredItem<Item> PURPLE_ORE = block(ParseModBlocks.PURPLE_ORE);
	public static final DeferredItem<Item> PURPLE_BLOCK = block(ParseModBlocks.PURPLE_BLOCK);
	public static final DeferredItem<Item> PURPLE_PICKAXE = REGISTRY.register("purple_pickaxe", PurplePickaxeItem::new);
	public static final DeferredItem<Item> PURPLE_AXE = REGISTRY.register("purple_axe", PurpleAxeItem::new);
	public static final DeferredItem<Item> PURPLE_SWORD = REGISTRY.register("purple_sword", PurpleSwordItem::new);
	public static final DeferredItem<Item> PURPLE_SHOVEL = REGISTRY.register("purple_shovel", PurpleShovelItem::new);
	public static final DeferredItem<Item> PURPLE_HOE = REGISTRY.register("purple_hoe", PurpleHoeItem::new);
	public static final DeferredItem<Item> PURPLE_ARMOR_HELMET = REGISTRY.register("purple_armor_helmet", PurpleArmorItem.Helmet::new);
	public static final DeferredItem<Item> PURPLE_ARMOR_CHESTPLATE = REGISTRY.register("purple_armor_chestplate", PurpleArmorItem.Chestplate::new);
	public static final DeferredItem<Item> PURPLE_ARMOR_LEGGINGS = REGISTRY.register("purple_armor_leggings", PurpleArmorItem.Leggings::new);
	public static final DeferredItem<Item> PURPLE_ARMOR_BOOTS = REGISTRY.register("purple_armor_boots", PurpleArmorItem.Boots::new);
	public static final DeferredItem<Item> PURPLE_WORLD = REGISTRY.register("purple_world", PurpleWorldItem::new);
