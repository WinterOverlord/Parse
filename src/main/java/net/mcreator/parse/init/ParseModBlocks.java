...
import net.mcreator.parse.block.PurpleWorldPortalBlock;
import net.mcreator.parse.block.PurpleOreBlock;
import net.mcreator.parse.block.PurpleBlockBlock;
...
public class ParseModBlocks {
	...
	public static final DeferredBlock<Block> PURPLE_ORE = REGISTRY.register("purple_ore", PurpleOreBlock::new);
	public static final DeferredBlock<Block> PURPLE_BLOCK = REGISTRY.register("purple_block", PurpleBlockBlock::new);
	public static final DeferredBlock<Block> PURPLE_WORLD_PORTAL = REGISTRY.register("purple_world_portal", PurpleWorldPortalBlock::new);
