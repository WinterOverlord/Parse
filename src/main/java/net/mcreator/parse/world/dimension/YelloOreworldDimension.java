...
package net.mcreator.parse.world.dimension;
...
public class YelloOreworldDimension {
	@EventBusSubscriber(bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
	public static class YelloOreworldSpecialEffectsHandler {
		@SubscribeEvent
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(ResourceLocation.parse("parse:yello_oreworld"), customEffect);
		}
	}
}
